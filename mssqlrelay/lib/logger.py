...
def init(ts=False):
    ...
    _logging.getLogger("mssqlrelay").addHandler(handler)
    _logging.getLogger("mssqlrelay").setLevel(_logging.INFO)
    _logging.getLogger("mssqlrelay").propagate = False


logging = _logging.getLogger("mssqlrelay")